...
<div class="d-flex justify-content-center">
	<div class="contents-box">
		...
		<div class="timeline-box my-5">
			<c:forEach items="${cardList}" var="post">
			<%-- 카드1 --%>
			<div class="card border rounded mt-3">
				...
				<div class="card-like m-3">
					<%-- 좋아요가 되어 있을 떄 --%>
					<c:if test="${card.filedLike eq true}">
					...
					<%-- 좋아요가 해제되어 있을 때 --%>
					<c:if test="${card.filedLike eq false}">
					<a href="#" class="like-btn">
				...
				<div class="card-comment-list m-2">
					...
					<%-- 댓글 내용 --%>
					<c:foreach items="${card.commentList}" var="commentView"> <!-- commentView는 댓글 1개라고 생각을 하자 -->
...
$(document).ready(function() {
	...
	$('.comment-btn').on('click', function() {
		...
		// 좋아요 
		$('.like-btn').on('click', function('post-id'){
			e.preventDefault();
